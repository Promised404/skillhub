...
: "${SKILLHUB_WEB_AUTH_PRIVATE_SSO_TWO_FACTOR_ENABLED:=false}"
: "${SKILLHUB_WEB_AUTH_PRIVATE_SSO_SM2_PUBLIC_KEY:=}"

# Generate runtime-config.js
envsubst '${SKILLHUB_WEB_API_BASE_URL} ${SKILLHUB_PUBLIC_BASE_URL} ${SKILLHUB_WEB_AUTH_DIRECT_ENABLED} ${SKILLHUB_WEB_AUTH_DIRECT_PROVIDER} ${SKILLHUB_WEB_AUTH_SESSION_BOOTSTRAP_ENABLED} ${SKILLHUB_WEB_AUTH_SESSION_BOOTSTRAP_PROVIDER} ${SKILLHUB_WEB_AUTH_SESSION_BOOTSTRAP_AUTO} ${SKILLHUB_WEB_AUTH_PRIVATE_SSO_TWO_FACTOR_ENABLED} ${SKILLHUB_WEB_AUTH_PRIVATE_SSO_SM2_PUBLIC_KEY}' \
